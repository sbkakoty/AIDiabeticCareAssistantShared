...
**AIDiabeticCareAssistantShared** is a Kotlin Multiplatform (KMP) shared library for the **AI Diabetic Care Assistant** application.
...
│           └── XCFrameworks/
│               └── release/
│                   └── AIDiabeticCareAssistantShared.xcframework
│
├── gradle/
├── gradlew
├── gradlew.bat
...
```bash
./gradlew :app:shared:assembleAIDiabeticCareAssistantSharedReleaseXCFramework
```
...
```bash
ditto -c -k --sequesterRsrc --keepParent AIDiabeticCareAssistantShared.xcframework AIDiabeticCareAssistantShared.xcframework.zip
```

Calculate the Swift Package checksum:

```bash
swift package compute-checksum AIDiabeticCareAssistantShared.xcframework.zip
```
...
└── GitHub Release
    │
    └── 1.0.1
        └── AIDiabeticCareAssistantShared.xcframework.zip
```
...
```text
https://github.com/sbkakoty/AIDiabeticCareAssistantShared/releases/tag/1.0.1
```

### Binary download URL

```text
https://github.com/sbkakoty/AIDiabeticCareAssistantShared/releases/download/1.0.1/AIDiabeticCareAssistantShared.xcframework.zip
```
...
```text
/releases/download/1.0.1/AIDiabeticCareAssistantShared.xcframework.zip
```
...
```text
https://github.com/sbkakoty/AIDiabeticCareAssistantShared.git
```
...
```swift
import AIDiabeticCareAssistantShared
```
...
```text
/releases/download/<version>/AIDiabeticCareAssistantShared.xcframework.zip
```
...
https://github.com/sbkakoty/AIDiabeticCareAssistantShared
